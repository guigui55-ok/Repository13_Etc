...
'############################################
'スクリプト関数をインポートする ★★★確認★★★
ReadDir = "C:\Users\OK\source\repos\Repository5_Etc\vbs"
...
'############################################
'ログファイルのパスを設定する　★★★確認★★★
objLogger.SetPath(GetCurrentDirectory() + "\_MoveFilesJpg_Log.txt")
'############################################
...
'############################################
'############################################
'Dim MoveDir: MoveDir = GetCurrentDirectory()
'############################################
